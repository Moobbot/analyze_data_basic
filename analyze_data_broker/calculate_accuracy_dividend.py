...
GT_DIR = BASE_DIR / "datasets" / "test-set-broker" / "labels" / "Dividend"
MODEL_CSV = BASE_DIR / "danh_gia_ket_qua" / "dividend_advice_2026_02_03.csv"
OUTPUT_DIR = BASE_DIR / "danh_gia_ket_qua" / "2026_02_04"
OUTPUT_FILE = OUTPUT_DIR / "accuracy_report_dividend.xlsx"
...
def main():
    ...
    acc, prec, rec, f1 = create_excel_report(
        wb, gt, model, results, matched, DIVIDEND_FIELDS
    )
    wb.save(OUTPUT_FILE)
    print("=" * 80)
