...
GT_DIR = BASE_DIR / "datasets" / "test-set-broker" / "labels" / "Trade_Confirmation"
MODEL_CSV = BASE_DIR / "danh_gia_ket_qua" / "trade_confirmation_2026_02_03.csv"
OUTPUT_DIR = BASE_DIR / "danh_gia_ket_qua" / "2026_02_04"
OUTPUT_FILE = OUTPUT_DIR / "accuracy_report_trade_confirmation.xlsx"
...
def main():
    ...
    results = []
    for field in TRADE_CONFIRMATION_FIELDS:
    ...
    acc, prec, rec, f1 = create_excel_report(
        wb, gt, model, results, matched, TRADE_CONFIRMATION_FIELDS
    )
    wb.save(OUTPUT_FILE)
    print("=" * 80)
