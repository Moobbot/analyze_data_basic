...
- **Khoảng trắng (Spaces):**
  ...
  - `DD Mon, YYYY` (e.g., 03 Oct, 2023)
  - `D Mon YYYY` (e.g., 3 Oct 2023) - _Day without leading zero_
...
- **Số thứ tự (Ordinal):**
  ...
  - `MONTHDaySuffix, Year` (e.g., NOVEMBER25TH, 2022)
  - `MONTH DaySuffix, Year` (e.g., NOVEMBER 25TH, 2022) - _With space_
  - `MonthDaySuffix,Year` (e.g., Jul 1st,2025) - _No space after comma_
...
- **Ký tự ẩn (Hidden Characters):**
  - `DD­Mon­YYYY` (e.g., 01­Nov­2021) - _Contains Soft Hyphen (U+00AD)_
